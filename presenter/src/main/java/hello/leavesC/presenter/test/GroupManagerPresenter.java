package hello.leavesC.presenter.test;
...
import hello.leavesC.presenter.view.GroupInfoView;
import hello.leavesC.presenter.view.GroupManageMessageView;
import hello.leavesC.presenter.view.GroupManageView;
